...
void LedtTask02(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(myLed2, LedtTask02, osPriorityNormal, 0, 128);
  myLed2Handle = osThreadCreate(osThread(myLed2), NULL);

  /* definition and creation of myLed4 */
  osThreadDef(myLed4, LedTask04, osPriorityNormal, 0, 128);
  myLed4Handle = osThreadCreate(osThread(myLed4), NULL);
...
/* USER CODE BEGIN Header_LedtTask02 */
/**
* @brief Function implementing the myLed2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_LedtTask02 */
void LedtTask02(void const * argument)
{
  /* USER CODE BEGIN LedtTask02 */
  /* Infinite loop */
  for(;;)
  {
  ...
  /* USER CODE END LedtTask02 */
}

/* USER CODE BEGIN Header_LedTask04 */
/**
* @brief Function implementing the myLed4 thread.
* @param argument: Not used
* @retval None
*/
